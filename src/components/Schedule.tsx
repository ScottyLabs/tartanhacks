...
function TopBlock({
  ...
  return (
    <div
      className={`border p-1 rounded border-blue text-gray-200 flex flex-row justify-center items-center`}
      style={{ gridArea: area }}
    >
      <h1 className='text-lg text-center'>{title}</h1>
      <p className='text-sm text-center text-gray-400 ml-4 flex flex-row'>
        <span>{time}</span>
        {location && (
          <>
