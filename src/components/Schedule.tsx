export function Schedule() {
  return (
    <section
      className="relative flex flex-col items-center justify-center pb-24"
      id="schedule"
    >
      ...
      <h1 className="z-30 mt-24 px-10 font-basteleur text-5xl uppercase md:text-8xl">
        Schedule
      </h1>
      <div className="z-30 mx-10 w-3/4 pt-8 text-center font-sfpro text-white md:w-2/3">
        <div className="grid grid-cols-[1fr_2fr] gap-4">
          ...
          <div className="row-span-3 flex items-center justify-center border-[1px] p-2">
            4:00 PM
          </div>
          ...
          <div className="flex items-center justify-center border-[1px] p-2">
            5:00 PM
          </div>
          <div className="rounded-sm border-[1px] px-10 py-3">
          ...
          <div className="rounded-sm border-[1px] px-10 py-3">
            <p className="font-bold">
              Sponsor Event: AppLovin (Tech Talk/Networking)
            </p>
            <p className="">Connan</p>
          </div>
          <div className="flex items-center justify-center border-[1px] p-2">
      ...
      <div className="z-30 mx-10 mt-8 w-3/4 pt-8 text-center font-sfpro text-white md:w-2/3">
        <div className="grid grid-cols-[1fr_2fr] gap-4">
          ...
          <div className="row-span-2 flex items-center justify-center border-[1px] p-2">
            9:00 AM
          </div>
          <div className="rounded-sm border-[1px] px-10 py-3">
