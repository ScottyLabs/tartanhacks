    ...
    >
      ...
      <div className="text-white text-center text-xl font-sfpro w-2/3 md:w-1/2 z-30">
        <p>
          ...
          a 24-hour in person hackathon where participants from all over the
          country create innovative projects. Come on over to hack, connect with
          peers, and learn from our incredible speakers. Registration is now
          closed for all students who are not actively enrolled at CMU.
        </p>
      </div>
      <hr className="h-px my-8 w-3/4 md:w-2/3 bg-white border-0 z-30" />
    </section>
