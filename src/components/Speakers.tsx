          ...
          <div className="max-w-2xl space-y-12 py-8">
            <div className="flex-1 flex">
              ...
              <div>
                ...
                <p className="text-md">
                  Jasmine is an experienced Product Manager and Entrepreneur
                  with a passion for both consumer technology and business
                  strategy. Whether it&apos;s building devices or formulating
                  beauty products, she focuses on creating delightful
